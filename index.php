...
<head>
    <title>给雄姿化妆</title>
    <meta itemprop="name" content="给雄姿化妆" />
    <meta itemprop="description" content="给雄姿化妆" />
    <meta charset="utf-8" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">给雄姿化妆</div><br />
                ...
                <div id="btn_group" style="display: block;">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="mode">
                            ...
                            <li><a class="dropdown-item" onclick="changeMode(MODE_ENDLESS)">觉撒模式</a></li>
